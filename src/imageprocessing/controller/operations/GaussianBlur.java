...
/**
 * Function object that allows the controller to delegate to the model to gaussianBlur.
 */
public class GaussianBlur implements ImagesCommand {
  private final String origName;
  private final String copyName;

  /**
   * Constructs the function object to apply the gaussianBlur filter, the original name and
   ...
   */
  public GaussianBlur(String orig, String copy) throws NullPointerException {
  ...
  public void run(Map<String, Image> imageStorage) {
    if (imageStorage.get(this.origName).getClass() == ImageInputMock.class) {
      ...
      imageToOperate.gaussianBlurImage();
    } else {
