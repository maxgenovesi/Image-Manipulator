...
/**
 * Function object that allows the controller to delegate to the model to greyScaleValue.
 */
public class ValueGreyscale implements ImagesCommand {
  private final String origName;
  private final String copyName;

  /**
   * Constructs the function object to greyScale by each pixel's value. The original name and
   ...
   */
  public ValueGreyscale(String orig, String copy) throws NullPointerException {
  ...
  public void run(Map<String, Image> imageStorage) {
    if (imageStorage.get(this.origName).getClass() == ImageInputMock.class) {
      ...
      imageToOperate.greyScaleValueImage();
    } else {
