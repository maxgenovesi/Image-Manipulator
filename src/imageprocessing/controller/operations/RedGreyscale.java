...
/**
 * Function object that allows the controller to delegate to the model to greyScaleColor red.
 */
public class RedGreyscale implements ImagesCommand {
  private final String origName;
  private final String copyName;

  /**
   * Constructs the function object to greyScale by the color red, the original name and copy's
   * name are specified.
   *
   ...
   */
  public RedGreyscale(String orig, String copy) throws NullPointerException {
  ...
  public void run(Map<String, Image> imageStorage) {
    if (imageStorage.get(this.origName).getClass() == ImageInputMock.class) {
      ...
      imageToOperate.greyScaleColorImage("red");
    } else {
