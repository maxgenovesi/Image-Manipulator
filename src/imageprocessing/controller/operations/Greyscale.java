...
/**
 * Function object that allows the controller to delegate to the model to greyScale.
 */
public class Greyscale implements ImagesCommand {
  private final String origName;
  private final String copyName;

  /**
   * Constructs the function object to apply the greyScale transformation, the original name and
   ...
   */
  public Greyscale(String orig, String copy) throws NullPointerException {
