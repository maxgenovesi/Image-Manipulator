 ...
 * horizontal axis.
 */
public class HorizontalFlip implements ImagesCommand {
   ...
   */
  public HorizontalFlip(String orig, String copy) throws NullPointerException {
