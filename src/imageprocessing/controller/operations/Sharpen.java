...
/**
 * Function object that allows the controller to delegate to the model to sharpen.
 */
public class Sharpen implements ImagesCommand {
  private final String origName;
  private final String copyName;

  /**
   * Constructs the function object to apply the sharpen filter, the original name and
   ...
   */
  public Sharpen(String orig, String copy) throws NullPointerException {
